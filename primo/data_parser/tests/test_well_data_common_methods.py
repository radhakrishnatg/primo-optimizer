...
def test_dunder_methods(get_well_data_from_csv):
    ...
    assert wd[wd.column_names.age] is wd.data[wd.column_names.age]
    assert wd[wd.column_names.depth] is wd.data[wd.column_names.depth]
